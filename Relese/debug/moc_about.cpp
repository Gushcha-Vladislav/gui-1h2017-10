...
QT_MOC_LITERAL(3, 19, 23) // "on_pushButton_3_clicked"

    },
    "About\0firstWindow\0\0on_pushButton_3_clicked"
};
...
void About::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (About::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&About::firstWindow)) {
                *result = 0;
                return;
            }
        }
